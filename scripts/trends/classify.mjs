...
const COMMERCE = [
  "roblox", "robux", "steam wallet", "steam gift", "psn", "playstation network",
  "playstation store", "xbox game pass", "xbox live", "nintendo eshop",
  "pubg uc", "uc pubg", "free fire diamonds", "genshin genesis crystals",
  "valorant points", "fortnite v-bucks", "v-bucks", "vbucks", "apple gift card",
  "google play gift", "razer gold", "gift card", "top up", "top-up",
];

/** Platform and franchise vocabulary that reliably means games. */
const GAMES = [
  "steam", "playstation", "ps5", "ps4", "xbox", "nintendo switch", "switch 2",
  "epic games", "game pass", "speedrun", "gameplay", "dlc", "patch notes",
  "battle pass", "esports", "twitch drops", "early access", "open beta",
  "minecraft", "fortnite", "valorant", "genshin impact", "honkai", "zenless",
  "call of duty", "warzone", "elden ring", "gta", "grand theft auto",
  "league of legends", "counter-strike", "cs2", "dota", "overwatch", "apex legends",
  "pubg", "free fire", "mobile legends", "clash royale", "brawl stars",
  "pokemon", "zelda", "mario", "final fantasy", "resident evil", "silent hill",
  "baldur's gate", "cyberpunk 2077", "helldivers", "palworld", "marvel rivals",
];

/** Anime and manga vocabulary. */
const ANIME = [
  "anime", "manga", "manhwa", "manhua", "shonen", "shounen", "seinen", "shojo",
  "isekai", "crunchyroll", "studio ghibli", "mappa", "ufotable", "toei animation",
  "wit studio", "bones studio", "sub indo", "dub", "opening theme", "op theme",
  "light novel", "season 2", "season 3", "final season", "episode",
  "one piece", "naruto", "boruto", "bleach", "dragon ball", "jujutsu kaisen",
  "demon slayer", "kimetsu", "attack on titan", "shingeki", "chainsaw man",
  "solo leveling", "spy x family", "my hero academia", "hunter x hunter",
  "tokyo revengers", "blue lock", "frieren", "dandadan", "sakamoto days",
  "oshi no ko", "mushoku tensei", "re:zero", "overlord", "dr stone",
];
...
const COMPILED = DOMAINS.map(([domain, words]) => [
  domain,
  words.map((word) => ({ word, re: new RegExp(`(?:^|[^a-z0-9])${escape(word)}(?:[^a-z0-9]|$)`, "i") })),
]);
