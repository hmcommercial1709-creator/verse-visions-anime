...
export function RewardedAdModal({
  ...
  platformLabel,
  platformUrl,
  rewardLabel = "Continue to the official platform",
}: {
  open: boolean;
  onClose: () => void;
  onReward?: () => void;
      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-border bg-card shadow-2xl">
        ...
        <div className="p-5 pt-6">
          ...
          <h2 className="mt-2 font-display text-xl font-bold leading-snug">
            Watch a short sponsored ad to unlock the full summary or continue to the official platform
          </h2>
          <p className="mt-1 text-[13px] text-muted-foreground">
            Ads keep these summaries free for everyone. You can close this at any time.
          </p>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-xs text-muted-foreground" aria-live="polite">
              {rewarded ? "Reward unlocked" : `${left}s remaining…`}
            </p>
          </div>
