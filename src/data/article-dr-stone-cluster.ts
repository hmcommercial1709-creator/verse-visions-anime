      ...
      blocks: [
        {
          type: "table",
          caption:
            "Revival fluid ingredients and what each one does in the story",
          columns: [
            "Component",
            "Story Source",
            "Role in the Fiction",
          ...
          rows: [
            [
              "Nitric acid",
              "Deposits in the Miracle Cave",
              "Weakens or reacts with the petrification shell",
              "A real, highly corrosive acid",
            ],
            [
              "Alcohol",
              "Fermented and distilled plant sugars",
              "Combines with nitric acid to form the active mixture",
              "A real solvent and flammable liquid",
            ],
            [
              "Nital-like solution",
              "Nitric acid plus alcohol",
              "Reverses petrification",
              "Real nital etches metal; it does not revive life",
            ],
            [
              "Experimental control",
              "Repeated tests on stone fragments",
              "Identifies a reproducible result",
              "The scientific method is the most realistic part",
            ],
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          rows: [
            [
              "Purpose",
              "Etches metal for examination",
              "Reverses fictional petrification",
            ],
            [
              "Chemistry",
              "Nitric acid in an alcohol solvent",
              "A nital-like nitric-acid and alcohol mixture",
            ],
            [
              "Effect on humans",
              "Corrosive and dangerous",
              "Restorative only within the fiction",
            ],
            [
              "Safe home experiment?",
              "No",
              "No — the fictional outcome cannot occur",
            ],
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          options: [
            ...
            "It starts the Senku–Tsukasa conflict",
            "It proves petrification can be reversed",
            "It turns science into political power",
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          rows: [
            [
              ...
              "Holds and separates reactive chemicals",
              "Kaseki's craftsmanship and silica glass",
            ],
            [
              "Sulfur source",
              "Provides sulfur chemistry for the antibacterial compound",
              "The poisonous spring expedition",
            ],
            [
              "Acids and alkalis",
              "Drive intermediate reactions and purification",
              "Salt, sulfur, charcoal and controlled processing",
            ],
            [
              "Coal-derived feedstock",
              "Supplies aromatic chemical building blocks",
              "Mineral collection and furnace chemistry",
            ],
            [
              "Precision heating",
              "Keeps reactions within useful ranges",
              "Furnaces, charcoal and laboratory vessels",
            ],
            [
              "Clean water and containers",
              "Reduces contamination and enables repeatable batches",
              "Village labour and the glass shop",
            ],
            [
              "Diagnosis and observation",
              "Connects the medicine to a bacterial illness",
              "Senku's clinical reasoning and Ruri's history",
            ],
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          columns: [
            ...
            "Compressed for Storytelling",
          ],
          rows: [
            [
              "Drug class",
              "Sulfonamides are real antibacterials",
              "One successful project resolves the full treatment problem",
            ],
            [
              "Mechanism",
              "Bacterial metabolism can be selectively disrupted",
              "Diagnosis and response appear faster and clearer",
            ],
            [
              "Synthesis",
              "Organic chemistry can build a sulfonamide",
              "Hazards, by-products and purification are abbreviated",
            ],
            [
              "Equipment",
              "Glassware and controlled heat are essential",
              "Improvised parts reach pharmaceutical precision rapidly",
            ],
            [
              "Treatment",
              "Bacterial pneumonia may respond to an effective antibacterial",
              "Dose selection and clinical monitoring are simplified",
            ],
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          options: [
            "Saving Ruri",
            "Winning the village's trust",
            "Building the first real laboratory",
            "Proving the roadmap method works",
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          rows: [
            [
              ...
              "Magnets, copper, carbon chemistry and labour",
            ],
            [
              "Microphone",
              "Convert sound vibration into an electrical signal",
              "Carbon material, diaphragm and wiring",
            ],
            [
              "Fine conductive wire",
              "Carry signals and form coils",
              "Gold or copper processing and insulation",
            ],
            [
              "Vacuum tubes",
              "Amplify and control weak electrical signals",
              "Glassblowing, vacuum, heated elements and precision",
            ],
            [
              "Tuned circuit",
              "Select and generate the operating frequency",
              "Coils, capacitors and careful adjustment",
            ],
            [
              "Antenna",
              "Convert electrical oscillation into radio waves and back",
              "Conductive material, length and placement",
            ],
            [
              "Speaker or earphone",
              "Turn the received signal back into sound",
              "Magnet, coil and vibrating diaphragm",
            ],
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          columns: [
            "Problem",
            "Required Solution",
            "Likely Real-World Difficulty",
          ],
          rows: [
            [
              "Heated element",
              "A high-temperature material such as tungsten",
              "Shaping and mounting without contamination",
            ],
            [
              "Glass envelope",
              "Heat-resistant, precisely formed glass",
              "Cracks, inconsistent thickness and sealing",
            ],
            [
              "Low pressure",
              "A working vacuum pump and airtight joints",
              "Leaks and insufficient vacuum",
            ],
            [
              "Electrical feedthrough",
              "Metal connections sealed through glass",
              "Different thermal expansion rates",
            ],
            [
              "Consistent output",
              "Matched parts and circuit tuning",
              "Every handmade tube behaves differently",
            ],
          ],
        },
      ],
      ...
      blocks: [
        {
          type: "poll",
          question:
            "Which phone component is the biggest Stone World achievement?",
          options: [
            "The battery bank",
            "Fine wire",
            "Vacuum tubes",
