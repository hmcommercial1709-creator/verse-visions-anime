  ...
  sections: [
      ...
      blocks: [
        {
          ...
          rows: [
            ["Ten", "Keeps aura around the body for defence and stability", "Requires continuous control"],
            ["Zetsu", "Closes aura nodes to hide presence and recover", "Removes aura defence"],
            ["Ren", "Produces a larger and more forceful aura output", "Consumes energy and reveals strength"],
            ["Hatsu", "Expresses aura as a personal technique", "Depends on affinity, design and conditions"],
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "table",
          caption: "All six Nen types, their core functions and well-known examples",
          columns: ["Nen Type", "Core Function", "Examples"],
          rows: [
            ["Enhancement", "Strengthens the body, an object or an existing property", "Gon Freecss, Uvogin, Netero"],
            ["Emission", "Keeps aura effective after it leaves the body", "Razor, Leorio, Franklin"],
            ["Transmutation", "Gives aura the qualities of another substance or force", "Killua, Hisoka, Biscuit"],
            ["Conjuration", "Creates a material object with aura and defined rules", "Kurapika, Shizuku, Kite"],
            ["Manipulation", "Controls people, creatures or objects under set conditions", "Shalnark, Illumi, Morel"],
            ["Specialisation", "Produces effects that do not fit the other five categories", "Chrollo, Neon, Pitou"],
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          rows: [
            ["Gyo", "Concentrates aura to strengthen one area or reveal hidden aura", "Leaves less aura elsewhere"],
            ["In", "Conceals aura and Nen constructs", "Can be exposed by Gyo"],
            ["En", "Creates a sensing field around the user", "Range and precision vary; maintaining it is demanding"],
            ["Shu", "Wraps an object in aura", "Depends on control and the object being used"],
            ["Ken", "Maintains strong full-body offence and defence", "Consumes much more aura than Ten"],
            ["Ko", "Focuses almost all aura in one point", "The rest of the body becomes vulnerable"],
            ["Ryu", "Redistributes aura during an exchange", "Requires speed, judgement and precise control"],
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          rows: [
            ["Kurapika — Chain Jail", "Only usable on the Phantom Troupe, with a lethal penalty for misuse", "Overwhelming control against a tiny target group"],
            ["Chrollo — Skill Hunter", "Multiple requirements to steal and activate abilities", "A flexible library purchased with preparation"],
            ["Genthru — Countdown", "Explanation, contact and a timed activation process", "A remote threat that becomes stronger after disclosure"],
            ["Gon — Jajanken", "Charge time and a readable choice structure", "High output that opponents can interrupt or bait"],
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          options: ["Vows and restrictions", "Aura allocation and Ryu", "Hidden conditions", "Category matchups"],
        },
      ],
    },
    {
