...
export const studios: Studio[] = [
  ...
  { slug: "science-saru", name: "Science SARU", founded: 2013, country: "Japan", accent: "#db2777",
    blurb: "Co-founded by Masaaki Yuasa and Eunyoung Choi, and the most stylistically unrestrained studio working at this scale. Known for Devilman Crybaby, Ping Pong the Animation and the Dandadan adaptation, where the tonal swerves the manga makes on the page are carried by animation that swerves with them.",
    notable: ["dandadan"] },
