...
const animePosters: Record<string, MediaArt> = {
  ...
  "fullmetal-alchemist-brotherhood": art(
    pFullmetalAlchemistBrotherhood,
    pFullmetalAlchemistBrotherhood_s,
    1024,
    1536,
  ),
  ...
  "jojos-bizarre-adventure": art(
    pJojosBizarreAdventure,
    pJojosBizarreAdventure_s,
    1024,
    1536,
  ),
...
const articleBackdrops: Record<string, MediaArt> = {
  ...
  "why-frieren-won-2024": art(
    bWhyFrierenWon2024,
    bWhyFrierenWon2024_s,
    1536,
    864,
  ),
  "one-piece-wano-recap": art(
    bOnePieceWanoRecap,
    bOnePieceWanoRecap_s,
    1536,
    864,
  ),
  "beginner-guide-modern-shonen": art(
    bBeginnerGuideModernShonen,
    bBeginnerGuideModernShonen_s,
    1536,
    864,
  ),
  "review-jujutsu-kaisen-s2": art(
    bReviewJujutsuKaisenS2,
    bReviewJujutsuKaisenS2_s,
    1536,
    864,
  ),
  "top-10-anime-2026": art(bTop10Anime2026, bTop10Anime2026_s, 1536, 864),
  "chainsaw-man-reze-arc-preview": art(
    bChainsawManRezeArcPreview,
    bChainsawManRezeArcPreview_s,
    1536,
    864,
  ),
  "solo-leveling-s2-review": art(
    bSoloLevelingS2Review,
    bSoloLevelingS2Review_s,
    1536,
    864,
  ),
  "spy-x-family-cruise-arc": art(
    bSpyXFamilyCruiseArc,
    bSpyXFamilyCruiseArc_s,
    1536,
    864,
  ),
  "best-action-thriller-anime-2026": art(
    bBestAction2026_full,
    bBestAction2026_s,
    1536,
    864,
  ),
  // Watch-order guide reuses the owned Jujutsu Kaisen key visual (matches its og:image).
  "jujutsu-kaisen-watch-order-and-manga-jump": art(
    bReviewJujutsuKaisenS2,
    bReviewJujutsuKaisenS2_s,
    1536,
    864,
...
export const backdropFor = (slug: string, _hints: string[] = []): MediaArt =>
  articleBackdrops[slug] ??
  animePosters[slug] ??
  backdropLibrary[hash(slug) % backdropLibrary.length];

/** Descriptive alt text — original art, so it is described rather than credited. */
export const artAlt = (
  title: string,
  kind: "poster" | "backdrop" = "backdrop",
): string =>
  kind === "poster"
