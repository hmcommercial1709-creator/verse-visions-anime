...
export const STORE_LOCALES: StoreLocaleSeo[] = [
  {
    ...
    ogDescription:
      "39,000+ vertical 4K wallpapers, hand-picked and colour-graded. Instant download after payment. Card, wallet or crypto.",
  ...
  },
  {
    ...
    ogDescription:
      "縦型4K壁紙が39,000枚以上。決済後すぐにダウンロード。カード・ウォレット・暗号資産に対応。",
  ...
  },
  {
    ...
    ogDescription:
      "Más de 39.000 wallpapers verticales en 4K. Descarga inmediata tras el pago. Tarjeta, monedero o cripto.",
  ...
  },
  {
    ...
    ogDescription:
      "Plus de 39 000 wallpapers verticaux en 4K. Téléchargement immédiat après paiement. Carte, wallet ou crypto.",
  ...
  },
  {
    ...
    ogDescription:
      "Mais de 39.000 wallpapers verticais em 4K. Download imediato após o pagamento. Cartão, carteira ou cripto.",
