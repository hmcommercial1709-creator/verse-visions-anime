  ...
  return (
    <div style={styles.body}>
      <div style={styles.container}>
        {/* القسم الأول: البطاقات والمنتجات الرقمية في الأعلى */}
        <div style={styles.hero}>
          ...
          <input 
            type="text" 
            placeholder="🔍 Search digital keys, gift cards & subscriptions..."
            value={searchTerm}
        ...
        {/* القسم الثاني: مجسمات الأنمي في الأسفل */}
        <div style={{ marginTop: '80px', paddingTop: '40px', borderTop: '1px solid #1e293b' }}>
          <h2 style={{ color: '#fff', fontSize: '2rem', marginBottom: '30px', textAlign: 'center' }}>Featured Anime Figures & Collectibles</h2>
          <div style={styles.grid}>
