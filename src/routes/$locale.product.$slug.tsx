...
export const Route = createFileRoute("/$locale/product/$slug")({
  head: ({ loaderData }) => {
    ...
    const defaultDesc =
      "Buy instant digital game keys, gift cards, and streaming subscriptions with B2B automated delivery and wholesale pricing.";
      ...
      <div style={styles.container}>
        <div style={styles.hero}>
          ...
          <p style={styles.subtitle}>
            Direct automated inventory synced with Brolexy API. Thousands of active game keys and
            subscriptions with instant delivery.
          </p>
        ...
        <div style={styles.counter}>
          ...
          of {filteredProducts.length} live wholesale items (Profit Margin & Schema SEO Active)
        </div>
