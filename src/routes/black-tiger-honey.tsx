...
import productImg from "@/assets/bth/product.jpg";
...
const faqs = [
  { q: "كيف يتم استخدام عسل النمر الأسود؟", a: "ملعقة صغيرة واحدة (أو كيس واحد) على معدة فارغة أو قبل النشاط بنصف ساعة تقريباً، مرتين إلى ثلاث مرات في الأسبوع. يُفضل شرب كوب ماء بعده." },
  ...
  { q: "كيف أتأكد أن المنتج أصلي؟", a: "اطلب فقط عبر رقم الواتساب الرسمي الظاهر في هذه الصفحة، وتحقق من الختم والتغليف المحكم عند الاستلام." },
];
...
export const Route = createFileRoute("/black-tiger-honey")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "عسل النمر الأسود: خلطة طبيعية 100% للطاقة والحيوية الرجالية. توصيل سري وسريع ضمن سوريا والدفع عند الاستلام. اطلب الآن عبر الواتساب." },
      { property: "og:title", content: "عسل النمر الأسود · طاقة رجالية طبيعية 100%" },
      { property: "og:description", content: "طاقة فورية تدوم طويلاً بمكونات طبيعية بالكامل. توصيل سري وسريع ضمن سوريا." },
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 lg:grid-cols-2 lg:py-24">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg leading-relaxed text-[#cfc7b6]">
              عسل النمر الأسود خلطة فاخرة من العسل الخام والأعشاب الطبيعية 100%، تمنحك نشاطاً فورياً، تركيزاً أعلى، وحيوية
              تدوم معك طوال اليوم — بدون منشطات صناعية وبدون آثار جانبية.
            </p>
            <ul className="mt-6 grid gap-2 text-sm text-[#e7dcc2] sm:grid-cols-2">
              {["مكونات طبيعية 100%", "طاقة فورية وطويلة الأمد", "توصيل سري ضمن سوريا", "الدفع عند الاستلام"].map((t) => (
          ...
          <div className="relative">
            ...
            <img
              src={productImg}
              alt="عبوة عسل النمر الأسود الفاخرة بلون ذهبي"
              width={1024}
              height={1024}
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              {[
                { t: "توصيل سريع", d: "خلال 24–72 ساعة لجميع المحافظات السورية" },
      ...
      <footer className="border-t border-[#d4af37]/25 bg-[#0b0b0b]">
        <div className="mx-auto max-w-6xl px-4 py-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-[#a99f8c]">
            تواصل معنا مباشرة عبر الواتساب وسنساعدك في اختيار الكمية المناسبة وتأكيد طلبك خلال دقائق.
          </p>
