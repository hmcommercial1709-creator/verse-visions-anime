...
const faqs = [
  ...
  { q: "كم يستغرق التوصيل؟", a: "عادة من 24 إلى 72 ساعة حسب منطقتك، ويتم التواصل معك عبر الواتساب لتأكيد الطلب والعنوان قبل الشحن." },
  { q: "هل التوصيل سري؟", a: "بالتأكيد. يصلك الطلب بتغليف محايد بدون أي كتابة أو صورة تدل على محتواه، ولا نشارك بياناتك مع أي جهة." },
  { q: "هل الدفع عند الاستلام متاح؟", a: "نعم، الدفع عند الاستلام متاح في معظم المناطق. تأكد من التفاصيل مع فريقنا عبر الواتساب." },
