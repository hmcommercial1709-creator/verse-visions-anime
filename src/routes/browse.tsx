...
export const Route = createFileRoute("/browse")({
  head: () => ({
    meta: [
      ...
      { title: "Browse All Anime — Filter by Genre, Year & Studio · GameCastle Anime" },
      { name: "description", content: "Explore the GameCastle Anime library. Filter anime by genre, year, studio, status and rating to find your next series." },
      { property: "og:title", content: "Browse All Anime · GameCastle Anime" },
      { property: "og:description", content: "The GameCastle Anime anime library. Filter, sort, and discover." },
    ],
    links: [{ rel: "canonical", href: "https://gamecastle.store/browse" }],
    scripts: [
      {
        type: "application/ld+json",
        children: JSON.stringify(collectionSchema({ path: "/browse", name: 'All Anime — GameCastle Anime Library', description: 'Filter the full GameCastle Anime anime library by genre, year, studio, status and rating.' })),
      },
    ],
  }),
  component: Browse,
