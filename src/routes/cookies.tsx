...
export const Route = createFileRoute("/cookies")({
  head: () => ({ meta: [
    ...
    { title: "Cookie Policy · GameCastle Anime" },
    { name: "description", content: "What cookies GameCastle Anime uses and how to opt out." },
    { property: "og:title", content: "Cookie Policy · GameCastle Anime" },
  ...
  component: () => (
    <div className="mx-auto max-w-3xl px-4 lg:px-6 py-12">
      ...
      <div className="mt-6 space-y-4 text-foreground/85 leading-relaxed">
        <p>GameCastle Anime uses a small number of first-party and analytics cookies. Essential cookies keep the site running; analytics cookies help us understand what to write next.</p>
