...
export const Route = createFileRoute("/editorial-policy")({
  head: () => ({ meta: [
    ...
    { title: "Editorial Policy · GameCastle Anime" },
    { name: "description", content: "How GameCastle Anime's editorial team works: reviews, corrections, and affiliate disclosures." },
    { property: "og:title", content: "Editorial Policy · GameCastle Anime" },
  ...
  component: () => (
    <div className="mx-auto max-w-3xl px-4 lg:px-6 py-12">
      ...
      <div className="mt-6 space-y-4 text-foreground/85 leading-relaxed">
        <p>Reviews on GameCastle Anime are written by a single editor after watching the full available run of a series. Scores are the editor's opinion, not an aggregate.</p>
