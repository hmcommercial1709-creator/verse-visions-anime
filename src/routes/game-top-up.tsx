...
const services: Service[] = [
  {
    ...
    imageAlt: "PUBG Mobile top-up category card",
    glyph: "PUBG",
  ...
  },
  {
    ...
    image: "/gamivo/cards/free-fire.svg",
    imageAlt: "Free Fire top-up category card",
    glyph: "FF",
  ...
  },
  {
    ...
    imageAlt: "Fortnite digital credit category card",
    glyph: "FN",
  ...
  },
  {
    ...
    imageAlt: "Roblox gift card category card",
    glyph: "RBLX",
  ...
  },
  {
    ...
    image: "/gamivo/cards/valorant.svg",
    imageAlt: "Valorant top-up category card",
    glyph: "V",
  ...
  },
  {
    ...
    image: "/gamivo/cards/mobile-legends.svg",
    imageAlt: "Mobile Legends Bang Bang top-up category card",
    glyph: "MLBB",
  ...
  },
  {
    ...
    imageAlt: "Steam Wallet gift card category card",
    glyph: "STEAM",
  ...
  },
  {
    ...
    imageAlt: "PlayStation Store gift card category card",
    glyph: "PS",
  ...
  },
  {
    ...
    imageAlt: "Nintendo eShop gift card category card",
    glyph: "N",
...
export const Route = createFileRoute("/game-top-up")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:image",
        content: absoluteUrl("/gamivo/direct-top-ups-hero.svg"),
      },
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10">
        ...
        <div className="mx-auto max-w-7xl px-4 pb-16 pt-8 sm:px-6 lg:grid lg:grid-cols-[1.02fr_.98fr] lg:items-center lg:gap-12 lg:pb-24 lg:pt-16">
          ...
          <div className="relative mt-10 lg:mt-0">
            ...
            >
              <img
                src="/gamivo/direct-top-ups-hero.svg"
                width="1200"
                height="630"
