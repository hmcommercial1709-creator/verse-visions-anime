...
export const Route = createFileRoute("/genres")({
  head: () => ({
    meta: [
      ...
      { title: "All Anime Genres — Complete Directory · GameCastle Anime" },
      ...
      { property: "og:title", content: "Anime Genres · GameCastle Anime" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify(collectionSchema({ path: "/genres", name: 'Anime Genres Directory', description: 'Every anime genre covered by GameCastle Anime, from action and isekai to slice-of-life.' })),
      },
    ],
  }),
  component: () => (
