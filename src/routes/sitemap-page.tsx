  ...
  component: () => (
    <div className="mx-auto max-w-5xl px-4 lg:px-6 py-10">
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Section title="Pages">
          {["/","/anime/dandadan","/anime/dandadan/episode-guide","/anime/dandadan/characters","/anime/dandadan/occult-world","/anime/dandadan/watch-guide","/browse","/trending","/top-rated","/upcoming","/new-releases","/completed","/classic","/news","/reviews","/guides","/top-lists","/editorial","/authors","/manga-spoilers","/power-scaling","/watch-order","/timeline","/recommendations","/quotes","/facts","/soundtracks","/openings","/wallpapers","/rewards/anime-wallpapers","/streaming","/statistics","/about","/contact","/faq","/privacy-policy","/terms-of-service","/cookies","/dmca","/editorial-policy"].map(p => (
